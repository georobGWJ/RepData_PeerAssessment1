...
# Convert the intervals into interval class objects using lubridate
#activity_data$interval  <- as.interval(activity_data$interval, activity_data$date)
head(activity_data)
```
...
avg_daily_activity  <- data.frame(date = days, average_steps = avg_per_day)
